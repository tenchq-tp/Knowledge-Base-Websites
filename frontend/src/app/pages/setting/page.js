        ...
        <div
          style={{
            ...
            borderBottom: `2px solid ${
              userSettings.theme === "dark" ? "#404040" : "#e0e0e0"
            }`,
          }}
        >
          <h1
            style={{
              fontSize: "2.5rem",
              color: userSettings.theme === "dark" ? "#ffffff" : "#333",
              marginBottom: "0.5rem",
              fontWeight: "600",
            }}
          >
          ...
          <div
            style={{
              ...
              borderBottom: `1px solid ${
                userSettings.theme === "dark" ? "#404040" : "#f0f0f0"
              }`,
            }}
          >
            <FontAwesomeIcon
            ...
            <button
              ...
              onClick={() =>
                setIsEditing((prev) => ({ ...prev, user: !prev.user }))
              }
            >
              <FontAwesomeIcon icon={faEdit} />
              {isEditing.user
                ? t("settings.user.cancel")
          ...
          >
            ...
            >
              ...
              <input
                ...
                style={{
                  ...styles.input,
                  ...(isEditing.user ? {} : styles.inputDisabled),
                }}
              />
            </div>
          ...
          >
            ...
            >
              ...
              <select
                ...
                style={{
                  ...styles.input,
                  ...(isEditing.role ? {} : styles.inputDisabled),
                }}
              >
          ...
          >
            ...
            >
              ...
              >
                <FontAwesomeIcon
                  ...
                  style={{
                    fontSize: "1.2rem",
                    color:
                      userSettings.theme === "dark" ? "#4a90e2" : "#FFA500",
              ...
              <div
                ...
                style={{
                  ...
                  borderRadius: "15px",
                  backgroundColor:
                    userSettings.theme === "dark" ? "#4a90e2" : "#ccc",
                  position: "relative",
                  cursor: "pointer",
            ...
            <div
              style={{
                ...
                borderRadius: "8px",
                backgroundColor:
                  userSettings.theme === "dark" ? "#3d3d3d" : "#f8f9fa",
                border: `1px solid ${
                  userSettings.theme === "dark" ? "#404040" : "#e9ecef"
                }`,
              }}
            >
              <p
